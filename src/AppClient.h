...
public:
    ...
    static constexpr int VERSION_MAJOR_MIN = App::Version::Major;
    // Minimum required minor version of the RobotControl Core
    static constexpr int VERSION_MINOR_MIN = App::Version::Minor;
    // Minimum required patch version of the RobotControl Core
    static constexpr int VERSION_PATCH_MIN = App::Version::Patch;
...
protected:
     ...
     */
    virtual void AppFunctionHandler(const robotcontrolapp::AppFunction& function) = 0;
    /**
     ...
     * the changes.
     */
    virtual void UiUpdateHandler(const std::map<std::string, const robotcontrolapp::AppUIElement*>& updates) = 0;
