...
/**
 * @brief Gets a feature from the features list. Throws std::invalid_argument if
 * the feature is not defined (use HasFeature()!).
 * @brief Feature
 */
const LicenseDetails &
LicenseInfo::GetFeature(const std::string &featureID) const {
