...
TEST(App_LicenseInfoTest, ConstructorGRPC) {
...

  {
    ...
    /*robotcontrolapp::LicenseInfoResponse_LicenseDetails* feature1 =*/grpc
        .add_licensed_features();
...

  {
    ...
    robotcontrolapp::LicenseInfoResponse_LicenseDetails *feature1 =
        grpc.add_licensed_features();
    ...
    EXPECT_STREQ("2026-03-16T10:39:05",
                 li.features.begin()->second.expiryDate.c_str());
  }

  {
    ...
    robotcontrolapp::LicenseInfoResponse_LicenseDetails *feature2 =
        grpc.add_licensed_features();
    ...
    EXPECT_STREQ("2027-03-16T10:39:05",
                 li.features.begin()->second.expiryDate.c_str());
  }

  {
    ...
    robotcontrolapp::LicenseInfoResponse_LicenseDetails *feature3 =
        grpc.add_licensed_features();
